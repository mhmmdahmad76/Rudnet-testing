...
export default function AdminForgotPasswordPage() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    // Always the same destination, whether or not the address has an admin account.
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="t-body-sm text-fg-secondary">
          Enter the email on your admin account and we&rsquo;ll send a reset link.
        </p>
      </div>
      ...
      <p className="t-body-sm text-center text-fg-tertiary">
        <Link href="/admin/sign-in" className="text-fg-link hover:text-fg-link-hover">
          Back to sign in
        </Link>
      </p>
    </div>
