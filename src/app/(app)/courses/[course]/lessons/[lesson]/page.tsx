    ...
    return (
      <div className="mx-auto flex max-w-xl flex-col items-center gap-4 py-16 text-center">
        ...
        <p className="t-body-sm text-fg-secondary">
          Your free preview is done. Subscribe to unlock “{lesson.title}” and the rest of{" "}
          {DEMO_COURSE.title}.
        </p>
              ...
              <div className="flex flex-col gap-1">
                {unit.items.map((item) => (
                  <LessonRow
                    ...
                    href={
                      item.kind === "lesson"
                        ? `/courses/${params.course}/lessons/${item.id}`
                        : `/courses/${params.course}/quiz/${item.id}`
                    }
                  />
                ))}
              </div>
              ...
              onClick={() =>
                ...
                router.push(
                  previous.item.kind === "lesson"
                    ? `/courses/${params.course}/lessons/${previous.item.id}`
                    : `/courses/${params.course}/quiz/${previous.item.id}`,
                )
              }
            >
              Previous
              ...
              onClick={() =>
                ...
                router.push(
                  next.item.kind === "lesson"
                    ? `/courses/${params.course}/lessons/${next.item.id}`
                    : `/courses/${params.course}/quiz/${next.item.id}`,
                )
              }
            >
